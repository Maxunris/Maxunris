...
#### <a target="_blank" href="https://github.com/Maxunris/litres_project">Проект по  автоматизации тестирования на Python. web (UI) на Playwright и API онлайн библиотеки litres.ru (В процессе)</a>
### 📊 Статистика Github
